...
private:
   ...
   void rotar();        ///< rotación de 90 grados de la imagen en sentido horario

   /**
    @brief Destruye una imagen liberando su memoria
    */
...
/**
@brief Construye una imagen identica a @a copia
...
@param copia    imagen que se va a copiar

*/
   Imagen & operator = (const Imagen & copia);

/**
@brief Sobrecarga del operador de suma
@param copia    imagen que se va a unir por la derecha

*/

   Imagen operator + (const Imagen & copia) const;
...
/**
@brief Gira una imagen
@param grados       numero de grados que gira la imagen
@param shorario 	valdrá true si queremos que el giro sea horario
*/
   void rotacion(int grados, bool shorario);
};
